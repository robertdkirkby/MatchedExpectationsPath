% Heterogeneous-Agent Real Business Cycle Model 4: Quasi-Hyperbolic Discounting in the Krusell & Smith (1998) model
...
% These few lines are the only change from the HARBCmodel1 codes
...
ReturnFn=@(aprime,a,z,r,sigma,alpha,delta)...
    HARBCmodel4_ReturnFn(aprime,a,z,r,sigma,alpha,delta);
